...
public class GetNPosts extends AsyncTask<Void, Void, ArrayList<String>> {
		...
		protected ArrayList<String> doInBackground(Void... params) {
			...
			try {
				...
				HttpResponse response = HttpService.sendGETRequest("getNPosts/"
						+ n);
