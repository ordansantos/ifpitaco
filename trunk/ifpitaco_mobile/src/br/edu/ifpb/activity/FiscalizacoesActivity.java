...
public class FiscalizacoesActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		listview = (ListView) findViewById(R.id.listFiscalizacoes);
	...
	private class GetProposta extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... params) {
			...
			try {
				...
				HttpResponse response = HttpService.sendGETRequest("getFiscalizacoes");
				...
				JSONArray jsonArray = jsnobject.getJSONArray("fiscalizacoes");
				...
				for (int i = 0; i < jsonArray.length(); i++) {
					...
					myArrayList.add("\nO usuário " + nome_usuario
							+ " ficalizou acerca do(a) " + nome_ramo
